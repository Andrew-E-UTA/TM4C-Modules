...
#define MPU_DEF_ADDR 0x68

#define ACC_FS_0_DIV    16384.0f
#define ACC_FS_1_DIV    8192.0f
#define ACC_FS_2_DIV    4096.0f
#define ACC_FS_3_DIV    2048.0f


#define GYRO_FS_0_DIV   131.0f
#define GYRO_FS_1_DIV   65.5f
#define GYRO_FS_2_DIV   32.8f
#define GYRO_FS_3_DIV   16.4f
...
//configures 6050 for operation
void initMpu6050(uint8_t addr);

//averages x iterations to get the stationary offset
void calculateOffset(MpuData *offset);

//reads the current 6050 gyro accel and temp registers and returns
// xyz for both in g's and deg/s respectively
//if offset = 0 then it ignores offset
